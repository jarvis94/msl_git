...
%     cap dimensions in nm
    ...
    esum3 = -1*sum(Ey(nxedge_21:nxedge_22,nyedge_2b))
    esum3e = -1*sum(Ex(nxedge_21,nyedge_2b))
    esum4e = -1*sum(Ex(nxedge_21,nyedge_2t))
    esum4 =  sum(Ey(nxedge_21:nxedge_22,nyedge_2t))
